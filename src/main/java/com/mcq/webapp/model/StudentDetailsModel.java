...
public class StudentDetailsModel {
    //FK_username, name, Firstname,Lastname,mobile1,mobile2,workplace,addressline1,addressline2,city,district
    @Id
    @NotBlank// @JoinColumn(name="username")
